...
gandalf <- c(10, 11, 13, 30, 22, 11, 10, 33, 22, 22)
saruman <- c(23, 66, 12, 43, 12, 10, 44, 23, 12, 17)
...
2. Uso de bucle **for** o **while**
3. Uso de condicionales **if- ifelse**
4. Uso de las funciones **range(), length()**
